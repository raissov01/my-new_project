      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        ...
        <section className="space-y-6">
          <section className="rounded-[1.75rem] border border-[var(--border)] bg-[var(--bg-elevated)] p-5 shadow-[var(--surface-shadow)] sm:p-6">
            ...
            <div className="mt-6 h-2 overflow-hidden rounded-full bg-[var(--bg-soft)]">
              <div
          ...
          <section className="rounded-[1.75rem] border border-[var(--border)] bg-[var(--bg-surface)] p-5 shadow-[var(--surface-shadow)] sm:p-6">
...
function QuickInfo({
  ...
  return (
    <div className="rounded-[1.4rem] border border-[var(--border)] bg-[var(--bg-surface)] p-5">
