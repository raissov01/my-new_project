...
func RegisterRoutes(router *gin.Engine) {
	...
	internal.Use(middleware.InternalAuth(deps.InternalAPIToken))
	{
		...
		internal.POST("/ielts/speaking/details", aiLimiter, wrapHTTP(deps.IELTSExaminer.SpeakingDetails))
		...
		internal.POST("/nuet/attempts/practice", wrapHTTP(deps.NUET.SubmitPracticeAttempt))
		internal.POST("/nuet/attempts/pdf-test", wrapHTTP(deps.NUET.SubmitPDFTestAttempt))
