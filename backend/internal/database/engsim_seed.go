...
var curriculum = []unitDef{
	...
	// ── B1 Level — General English (replaces IELTS units) ──
	...
	{Level: "C2", Course: "GENERAL", Title: "Professional Contexts", Desc: "Business communication, negotiation, formal register", Skill: "writing", Emoji: "💼", Color: "#0f172a", Lessons: []lessonDef{
	...
	// ── IELTS Path (shown on /ielts/roadmap, not on /learn/map) ──
