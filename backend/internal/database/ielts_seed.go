...
func buildLegacyQuestionSeed() []models.IELTSQuestion {
	...
	readingQuestions := []seedObjectiveQuestion{
		{
			ExamSet:      "cambridge-17-test-1",
			Group:        "cambridge-17-test-1-reading-1",
			...
			BandTarget:   "6.5",
			SortOrder:    2001,
			Content:      "A growing number of cities have begun experimenting with rooftop farming. Supporters argue that these spaces can reduce transport costs, cool buildings and reconnect city residents with food production. However, critics point out that rooftop farms require careful structural planning and often produce less food than people expect.",
			Prompt:       "According to the passage, one concern about rooftop farming is that it",
			Options:      []string{"produces food too slowly", "needs specialist planning", "cannot reduce transport costs", "is unpopular with city residents"},
			Answer:       "needs specialist planning",
			Explanation:  "The passage says rooftop farms require careful structural planning.",
		},
		{
			ExamSet:      "cambridge-17-test-1",
			Group:        "cambridge-17-test-1-reading-1",
			...
			SortOrder:    2002,
			Content:      "A growing number of cities have begun experimenting with rooftop farming. Supporters argue that these spaces can reduce transport costs, cool buildings and reconnect city residents with food production. However, critics point out that rooftop farms require careful structural planning and often produce less food than people expect.",
			Prompt:       "Rooftop farms are described as helping residents feel closer to food production.",
			Answer:       "true",
			Explanation:  "The passage explicitly says rooftop farming can reconnect city residents with food production.",
		},
		{
			ExamSet:      "cambridge-17-test-2",
			Group:        "cambridge-17-test-2-reading-1",
			MockType:     "cambridge_style",
			Title:        "Why people keep notebooks",
			Topic:        "Study",
			QuestionType: "matching",
			Difficulty:   "medium",
			BandTarget:   "6.5",
			SortOrder:    2003,
			Content:      "Researchers studying the use of notebooks found three main reasons people still prefer paper in certain situations: paper is easier to scan visually, it creates fewer digital distractions, and it supports flexible sketching when ideas are still unfinished.",
			Prompt:       "Match the reason to the correct benefit: 'flexible sketching'",
			Options:      []string{"A. fewer distractions", "B. unfinished ideas can be explored", "C. quicker visual scanning"},
			Answer:       "B. unfinished ideas can be explored",
			Explanation:  "Flexible sketching was linked to exploring unfinished ideas.",
		},
		{
	...
	listeningQuestions := []seedObjectiveQuestion{
		{
			ExamSet:      "cambridge-17-test-1",
			Group:        "cambridge-17-test-1-listening-1",
			MockType:     "cambridge_style",
			Title:        "Student housing enquiry",
			Topic:        "Accommodation",
			QuestionType: "fill_blank",
			Difficulty:   "easy",
			BandTarget:   "6.0",
			SortOrder:    3001,
			AudioScript:  "Woman: Hello, I'm calling about the room advertised near the campus. Man: Certainly. The room is available from Monday and the weekly rent is one hundred and forty pounds, including internet. Woman: Great. Is there a deposit? Man: Yes, but it's refundable if the room is left clean.",
			Prompt:       "The weekly rent is £______.",
			Answer:       "140",
			Explanation:  "The speaker says the weekly rent is one hundred and forty pounds.",
		},
		{
			ExamSet:      "cambridge-17-test-1",
			Group:        "cambridge-17-test-1-listening-1",
			...
			SortOrder:    3002,
			AudioScript:  "Woman: Hello, I'm calling about the room advertised near the campus. Man: Certainly. The room is available from Monday and the weekly rent is one hundred and forty pounds, including internet. Woman: Great. Is there a deposit? Man: Yes, but it's refundable if the room is left clean.",
			Prompt:       "What is included in the rent?",
			Options:      []string{"Electricity only", "Internet", "Meals", "Cleaning"},
			Answer:       "Internet",
			Explanation:  "The man says the rent includes internet.",
		},
		{
			ExamSet:      "cambridge-17-test-2",
			Group:        "cambridge-17-test-2-listening-1",
			MockType:     "cambridge_style",
			...
			BandTarget:   "6.5",
			SortOrder:    3003,
			AudioScript:  "Coordinator: Volunteers should arrive by 8.30 for the briefing. The main exhibition opens at 10, but visitors begin entering the lobby from about 9.30. You'll mostly help families find the interactive science zone and answer simple questions about tickets.",
			Prompt:       "Visitors start arriving only after 10 o'clock.",
			Answer:       "false",
			Explanation:  "The coordinator says visitors begin entering the lobby from about 9.30.",
		},
		{
