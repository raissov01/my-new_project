...
func buildIELTSQuestionSeed() []models.IELTSQuestion {
	...
	// Imported from the IELTS predictions bot: Writing Task 2 + Speaking P1/2/3
	// (cleaned prediction PDFs, text-only). Generated by scripts/gen_predictions_bank.py.
	questions = append(questions, buildPredictionsBotBank()...)
	return questions
}
