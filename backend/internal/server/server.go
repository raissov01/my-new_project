...
func buildDependencies(cfg *config.Config, pool *pgxpool.Pool, gormDB *gorm.DB) handler.Dependencies {
	...
	return handler.Dependencies{
		...
		IELTSExaminer:      handler.NewIELTSExaminer(gormDB, cfg.OpenAIAPIKey, cfg.OpenAIModel, cfg.ClaudeAPIKey, cfg.ClaudeModel, cfg.ClaudeAPIURL, cfg.GeminiAPIKey, cfg.GeminiModel, cfg.AIRequestTimeout),
		IELTSAttempt:       handler.NewIELTSAttempt(gormDB),
		IELTSStudyPlan:     handler.NewIELTSStudyPlan(gormDB, cfg.OpenAIAPIKey, cfg.OpenAIModel, cfg.ClaudeAPIKey, cfg.ClaudeModel, cfg.ClaudeAPIURL, cfg.GeminiAPIKey, cfg.GeminiModel, cfg.AIRequestTimeout),
